  ...
  _renderShell() {
    ...
    this.shadowRoot.innerHTML = `<style>
      ...
      *{box-sizing:border-box}ha-card{overflow:hidden;border:1px solid var(--edge);border-left:4px solid var(--accent);border-radius:18px;background:var(--surface);box-shadow:var(--state-card-shadow,var(--ha-card-box-shadow,0 12px 30px rgba(0,0,0,.18)))}
      ...
      @media(max-width:600px){header{min-height:42px;padding:6px 9px}.heading{gap:7px}.heading>ha-icon{--mdc-icon-size:18px}h2{font-size:14px;line-height:1.1}.sub{display:none}.all{width:30px;height:30px;justify-content:center;padding:0}.all span{display:none}.grid{grid-template-columns:repeat(var(--columns,3),minmax(0,1fr));padding:0 7px 8px;gap:5px}.chips{display:none}.choose{display:grid;width:27px;height:27px}.choose ha-icon{--mdc-icon-size:15px}.bar{padding:5px 5px;gap:3px}.name b{font-size:10px}.name span,.activity span{display:none}.activity ha-icon{--mdc-icon-size:13px}.feed{aspect-ratio:16/9}}
