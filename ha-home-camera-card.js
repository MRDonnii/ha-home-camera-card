...
class HaHomeCameraCard extends HTMLElement {
  ...
  _renderShell() {
    ...
    this.shadowRoot.querySelectorAll("[data-feed]").forEach((feed) => feed.addEventListener("click", () => {
      const index = Number(feed.dataset.feed);
