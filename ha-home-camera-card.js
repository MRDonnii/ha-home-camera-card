...
class HaHomeCameraCard extends HTMLElement {
  ...
  _renderShell() {
    ...
    this.shadowRoot.innerHTML = `<style>
      ...
      *{box-sizing:border-box}ha-card{overflow:hidden;border:0;border-left:4px solid var(--accent);border-radius:18px;background:var(--surface);box-shadow:var(--state-card-shadow,var(--ha-card-box-shadow,0 12px 30px rgba(0,0,0,.18)))}
